...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MentionEditor = function (_React$Component) {
	  ...
	  function MentionEditor() {
	    ...
	    }, _this.onSearchChange = function (value, type) {
	      var searchValue = value.toLowerCase();
	      console.log('>> onSearchChange', searchValue, type);
	      var list = type === '@' ? originSuggestions : tagSuggestions;
	      var filtered = list.filter(function (suggestion) {
